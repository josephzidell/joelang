...
const visitorMap: Partial<Record<NT, visitor>> = {
	...
	[NT.FunctionSignature]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitFunctionSignature(node) as Result<T>,
	...
	[NT.MemberList]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitMemberList(node) as Result<T>,
	[NT.MemberListExpression]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitMemberListExpression(node) as Result<T>,
	...
	[NT.ObjectShape]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitObjectShape(node) as Result<T>,
	...
	[NT.PropertyShape]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitPropertyShape(node) as Result<T>,
	...
	[NT.TernaryAlternate]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitTernaryAlternate(node) as Result<T>,
	[NT.TernaryCondition]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitTernaryCondition(node) as Result<T>,
	[NT.TernaryConsequent]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitTernaryConsequent(node) as Result<T>,
	...
	[NT.TupleShape]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitTupleShape(node) as Result<T>,
	...
	[NT.TypeInstantiationExpression]: <T>(node: Node, analyzer: SemanticAnalyzer): Result<T> => analyzer.visitTypeInstantiationExpression(node) as Result<T>,
