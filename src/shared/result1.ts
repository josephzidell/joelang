...
// 	 */
// 	static array<T, E extends Error = Error, ED = unknown>(results: Result<T, E, ED>[]): Result<T[], E, ED> {
// 		if (allOk(results)) {
...
// 	static boolean<T extends boolean, E extends Error = Error, ED = unknown>(
// 		value: T,
// 		errorIfFalse: E,
// 		data?: ED,
// 	): Result<T, E, ED> {
...
// 	static possiblyUndefined<T, E extends Error = Error, ED = unknown>(
// 		value: T | undefined,
// 		errorIfUndefined: E,
// 		data?: ED,
// 	): Result<T, E, ED> {
